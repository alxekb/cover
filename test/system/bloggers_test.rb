...
class BloggersTest < ApplicationSystemTestCase
  ...
  test "creating a Blogger" do
    ...
    fill_in "About", with: @blogger.about
    fill_in "Account name", with: @blogger.account_name
    fill_in "Followers", with: @blogger.followers
    fill_in "Social network", with: @blogger.social_network
