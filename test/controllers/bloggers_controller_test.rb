...
class BloggersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogger" do
    assert_difference('Blogger.count') do
      post bloggers_url, params: { blogger: { about: @blogger.about, account_name: @blogger.account_name, followers: @blogger.followers, social_network: @blogger.social_network } }
    end
  ...
  test "should update blogger" do
    patch blogger_url(@blogger), params: { blogger: { about: @blogger.about, account_name: @blogger.account_name, followers: @blogger.followers, social_network: @blogger.social_network } }
